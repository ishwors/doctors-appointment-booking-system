...
def DOCTOR_DASHBOARD(request):
    ...
    today_bookings = Booking.objects.filter(doctor=doctor, date=today, status__in=['Confirmed', 'Completed'])
    upcoming_bookings = Booking.objects.filter(doctor=doctor, date__gt=today, status__in=['Confirmed', 'Completed'])
...
def PATIENT_DASHBOARD(request):
    ...
    booking_filter = Booking.objects.filter(patient_id=patient_id, status__in=['Confirmed', 'Completed']).order_by('-date')
